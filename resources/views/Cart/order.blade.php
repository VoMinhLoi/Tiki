...
<script>
    function checkedAll(){
        var checkBox = document.getElementById("checked-all-product");
    ...
    <div class="row">
        <div class="col l-9">
            ...
            @else
                ...
                <div class="product">
                    <a href="{{ route('product.detail',$product->id) }}" class="product-infor">
                    ...
                    <div class="product-pay">
                        ...
                        <div>
                            <div class="product__quantity">
                                <a class="product__quantity-number">{{ $item->quantity }}</a>
                            </div>
                        </div>
                        @php   
                        ...
                        <a href="{{ route('received', $item->id) }}" style="background: red; padding: 8px 12px; font-size: 10px; cursor: pointer; color: white;">{{ $item->status }}</a>
                    </div>
                </div>
                <?php 
                $totalPay += $totalPrice
